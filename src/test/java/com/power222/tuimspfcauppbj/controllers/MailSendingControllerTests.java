...
@WebMvcTest(MailSendingController.class)
public class MailSendingControllerTests {
    @Autowired
    private MockMvc mvc;
    ...
    void createContract() throws Exception {
        ...
        var actual = mvc.perform(post("/api/sendMail/contract").contentType(MediaType.APPLICATION_JSON).content(mapper.writeValueAsString(contract))).andReturn();

        assertThat(actual.getResponse().getStatus()).isEqualTo(HttpStatus.OK);
    }
