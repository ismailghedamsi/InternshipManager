...
public class MailSendingServiceTests {
    ...
    @BeforeEach
    public void setUp() {
        emptyEmployer = Employer.builder().build();
        expectedStudentApplication = StudentApplication.builder()
                ...
                .reasonForRejection("")
                .build();
        contract = MailContractDto.builder()
    ...
    public void sendEmailSuccess() throws MessagingException, IOException {
        ...
        service.sendEmail(employer);

        var actual = (String) ((MimeMultipart) ((MimeMultipart) mimeMessage.getContent()).getBodyPart(0).getContent()).getBodyPart(0).getContent();
        String expected = "<h1> This is your contract </h1>";

        assertThat(actual).isEqualTo(expected);
        assertThat(mimeMessage.getAllRecipients()[0].toString()).isEqualTo(employer.getEmail());
        assertThat(mimeMessage.getSubject()).isEqualTo("Internship contract");
