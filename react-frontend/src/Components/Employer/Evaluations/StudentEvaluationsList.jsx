                                ...
                                {currentEvaluationIndex === k && (
                                        <div>
                                            ...
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    Nom de l'entrprise :
                                                </strong> {e.contract.studentApplication.offer.employer.companyName}
                                            </Typography>
                                            <Typography> <strong style={{color: "blue"}}>
                                                Nom du superviseur :
                                            </strong> {e.contract.admin.name}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>Function
                                                    : </strong> {e.infos.supervisorRole}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>Telephone
                                                    : </strong> {e.infos.phoneNumber}
                                            </Typography>
                                            <hr/>
                                            ...
                                            <Typography>
                                                ...
                                                </strong> {e.productivity.efficiency}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    b) comprendre rapidement les directives relatives à son
                                                    travail :
                                                </strong> {e.productivity.comprehension}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    c) maintenir un rythme de travail soutenu :
                                                </strong> {e.productivity.rythm}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    d) établir ses priorités :
                                                </strong> {e.productivity.priorities}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    e) respecter ses échéanciers :
                                                </strong> {e.productivity.deadlines}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>Commentaire
                                                    : </strong> {e.productivity.comment}
                                            </Typography>
                                            <hr/>
                                            ...
                                            <Typography>
                                                ...
                                                </strong> {e.relationships.connectsEasily}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    b) contribuer activement au travail d’équipe :
                                                </strong> {e.relationships.teamworkContribution}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    c) s’adapter facilement à la culture de l’entreprise :
                                                </strong> {e.relationships.culturalAdaptation}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    d) accepter les critiques constructives :
                                                </strong> {e.relationships.acceptsCriticism}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    e) être respectueux envers les gens :
                                                </strong> {e.relationships.respectsOthers}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    f) faire preuve d’écoute active en essayant decomprendre le
                                                    point de vue de l’autre :
                                                </strong> {e.relationships.activelyListens}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>Commentaire
                                                    : </strong> {e.relationships.comment}
                                            </Typography>
                                            <hr/>
                                            ...
                                            <Typography>
                                                ...
                                                </strong> {e.skills.showsInterest}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    b) exprimer clairement ses idées :
                                                </strong> {e.skills.expressesOwnIdeas}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    c) faire preuve d’initiative :
                                                </strong> {e.skills.showsInitiative}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    d) travailler de façon sécuritaire :
                                                </strong> {e.skills.worksSafely}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    e) démontrer un bon sens des responsabilités ne requérant
                                                    qu’un minimum de supervision :
                                                </strong> {e.skills.dependable}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    f) être ponctuel et assidu à son travail :
                                                </strong> {e.skills.punctual}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>Commentaire</strong> {e.skills.comment}
                                            </Typography>
                                            <hr/>
                                            ...
                                            <Typography>
                                                <strong style={{color: "blue"}}>Expectation
                                                    : </strong> {e.appreciation.expectations}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    PRÉCISEZ VOTRE APPRÉCIATION :
                                                </strong> {e.appreciation.comment}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    Cette évaluation a été discutée avec le stagiaire :
                                                </strong> {e.appreciation.discussedWithIntern}
                                            </Typography>
                                            <hr/>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    ...
                                                    stagiaire :
                                                </strong> {e.feedback.weeklySupervisionHours}
                                            </Typography>
                                            <hr/>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    ...
                                                    STAGE :
                                                </strong> {e.feedback.hireAgain}
                                            </Typography>
                                            <Typography>
                                                <strong style={{color: "blue"}}>
                                                    La formation technique du stagiaire était-elle suffisante
                                                    pour accomplir le mandat de
                                                    stage? </strong> {e.feedback.technicalFormationOpinion}
                                            </Typography>
                                            <Typography color={"textSecondary"} variant={"body2"}>
                                                <strong style={{color: "blue"}}> Nom
                                                    : </strong> {e.contract.studentApplication.student.firstName +
                                            " " +
                                            ...
                                            <Typography>
                                                <strong style={{color: "blue"}}> Date : </strong> {e.signature.date}
                                            </Typography>
