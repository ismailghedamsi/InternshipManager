            ...
            {data ? <div>
                <div className={classes.evaluationSections}>
                    ...
                    <Typography>
                        {" "}
                        <span
                            className={classes.evaluationCriterias}>Programme d’études :</span> {data.infos.studentProgram}
                    </Typography>
                    ...
                    <Typography>
                        {" "}
                        <span
                            className={classes.evaluationCriterias}>Nom du superviseur :</span> {data.application.contract.adminName}
                    </Typography>
                    <Typography> <span
                ...
                <div className={classes.evaluationSections}>
                    ...
                    <Typography> <span
                        className={classes.evaluationCriterias}>c) maintenir un rythme de travail soutenu :</span> {data.productivity.rythm}
                    </Typography>
                    <Typography> <span
                ...
                <div className={classes.evaluationSections}>
                    Qualite de travail
                    <Typography><span
                        className={classes.evaluationCriterias}>a) respecter les mandats qui lui ont été confiés</span> {data.quality.followsInstructions}
                    </Typography>
                    ...
                    <Typography><span
                        className={classes.evaluationCriterias}>d) rechercher des occasions de se perfectionner </span> {data.quality.strivesForPerfection}
                    </Typography>
                    <Typography><span
                        className={classes.evaluationCriterias}>e) faire une bonne analyse des problèmes rencontrés</span> {data.quality.problemAnalysis}
                    </Typography>
                    <Typography><span
                ...
                <div className={classes.evaluationSections}>
                    ...
                    <Typography> <span
                        className={classes.evaluationCriterias}>a) établir facilement des contacts avec les gens</span> {data.relationships.connectsEasily}
                    </Typography>
                    <Typography><span
                        className={classes.evaluationCriterias}>b) contribuer activement au travail d’équipe</span> {data.relationships.teamworkContribution}
                    </Typography>
                    <Typography><span
                        className={classes.evaluationCriterias}>c) s’adapter facilement à la culture de l’entreprise</span> {data.relationships.culturalAdaptation}
                    </Typography>
                    <Typography><span
                        className={classes.evaluationCriterias}>d) accepter les critiques constructives </span> {data.relationships.acceptsCriticism}
                    </Typography>
                    <Typography><span
                ...
                <div className={classes.evaluationSections}>
                    ...
                    <Typography><span
                        className={classes.evaluationCriterias}>f) être ponctuel et assidu à son travail</span> {data.skills.punctual}
                    </Typography>
                    <Typography><span
