                ...
                {data ? (
                        <div>
                          ...
                          <div className={classes.evaluationSections}>
                            ...
                            <Typography><span className={classes.evaluationCriterias}>e) être respectueux envers les gens</span> {data.relationships.respectsOthers}
                            </Typography>
                          ...
                          <div className={classes.evaluationSections}>
                            ...
                            <Typography>La formation technique du stagiaire était-elle suffisante pour accomplir le
                              mandat de stage? {data.feedback.technicalFormationOpinion}</Typography>
                            <img src={data.signature.image} alt="signature"/>

                            <Typography><span className={classes.evaluationCriterias}>Nom :</span> {data.infos.fullname}
                            </Typography>
                            <Typography> <span
                                    className={classes.evaluationCriterias}>Function :</span> {data.infos.supervisorRole}
                            </Typography>
                            ...
                            <Typography> <span
                                    className={classes.evaluationCriterias}>Date : </span> {data.signature.date}
                            </Typography>
                          </div>
                        </div>
                ) : (
