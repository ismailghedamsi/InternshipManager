...
function DataTable() {
    ...
    return <ThemeProvider theme={createMuiTheme(locales['frFR'])}>
        ...
        <EditManager manager={currentManager} isOpen={isEditModalOpen} hide={closeEditModal} setRows={setRows} setItemCount={setItemCount}/>
        <CreateManager isOpen={isCreateModalOpen} hide={closeCreateModal} setRows={setRows} setItemCount={setItemCount}/>
    </ThemeProvider>
}
